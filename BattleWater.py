...
photo1 = pygame.image.load('Zygarde.png')
photo2= pygame.image.load('Greninja.png')
...
while running:
    ...
    pygame.draw.rect(screen,BLUE,(0,565,180,105))
    pygame.draw.rect(screen,BLUE,(190,565,180,105))
    pygame.draw.rect(screen,BLUE,(380,565,180,105))
    pygame.draw.rect(screen,BLUE,(570,565,180,105))





    textSurf1, textRect1=text_objects('Water Shuriken',smallText)
    textSurf2, textRect2=text_objects('Water Pledge',smallText)
    textSurf3, textRect3=text_objects('Water Fuma Shuriken',smallText)
    textSurf4, textRect4=text_objects('Aerial Ace',smallText)
